      ...
      <div className="container">
        ...
        >
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 3 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(3);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 4 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(4);
              }}
              onMouseEnter={() => {
            ...
            <span>
              <strong>Pose de serrures</strong>
            </span>
          </SplideSlide>
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 5 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(5);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 6 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(6);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 7 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(7);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 8 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(8);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 9 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(9);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 10 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(10);
              }}
              onMouseEnter={() => {
            ...
            <span>
              <strong>Reproduction de clés</strong>
            </span>
          </SplideSlide>
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 11 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(11);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 12 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(12);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 13 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(13);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 14 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(14);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 15 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(15);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 16 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(16);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 17 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(17);
              }}
              onMouseEnter={() => {
          ...
          <SplideSlide>
            ...
            <div
              className={`bullet ${activeIndex === 18 ? "active" : ""}`}
              onClick={() => {
                handleItemClick(18);
              }}
              onMouseEnter={() => {
