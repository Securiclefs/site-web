...
const ServicesComponent = () => {
    ...
    const positionInfoBulle = () => {
        ...
        let slideVisible = document.querySelectorAll(".splide__slide.is-visible")
        let infoBulle = document.querySelectorAll(".info-bulle")
        let count = 0
            ...
            <div className="container">
                <Splide aria-label="Serrurier services" options={ {
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 1 ? 'active' : ''}`} onClick={() => {handleItemClick(1)}} onMouseEnter={() => {handleItemHover(1); positionInfoBulle(); }} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 2 ? 'active' : ''}`} onClick={() => {handleItemClick(2)}} onMouseEnter={() => {handleItemHover(2); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 3 ? 'active' : ''}`} onClick={() => {handleItemClick(3)}} onMouseEnter={() => {handleItemHover(3); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 4 ? 'active' : ''}`} onClick={() => {handleItemClick(4)}} onMouseEnter={() => {handleItemHover(4); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 5 ? 'active' : ''}`} onClick={() => {handleItemClick(5)}} onMouseEnter={() => {handleItemHover(5); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 6 ? 'active' : ''}`} onClick={() => {handleItemClick(6)}} onMouseEnter={() => {handleItemHover(6); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 7 ? 'active' : ''}`} onClick={() => {handleItemClick(7)}} onMouseEnter={() => {handleItemHover(7); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 8 ? 'active' : ''}`} onClick={() => {handleItemClick(8)}} onMouseEnter={() => {handleItemHover(8); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 9 ? 'active' : ''}`} onClick={() => {handleItemClick(9)}} onMouseEnter={() => {handleItemHover(9); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 10 ? 'active' : ''}`} onClick={() => {handleItemClick(10)}} onMouseEnter={() => {handleItemHover(10); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 11 ? 'active' : ''}`} onClick={() => {handleItemClick(11)}} onMouseEnter={() => {handleItemHover(11); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 12 ? 'active' : ''}`} onClick={() => {handleItemClick(12)}} onMouseEnter={() => {handleItemHover(12); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 13 ? 'active' : ''}`} onClick={() => {handleItemClick(13)}} onMouseEnter={() => {handleItemHover(13); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 14 ? 'active' : ''}`} onClick={() => {handleItemClick(14)}} onMouseEnter={() => {handleItemHover(14); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 15 ? 'active' : ''}`} onClick={() => {handleItemClick(15)}} onMouseEnter={() => {handleItemHover(15); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 16 ? 'active' : ''}`} onClick={() => {handleItemClick(16)}} onMouseEnter={() => {handleItemHover(16); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 17 ? 'active' : ''}`} onClick={() => {handleItemClick(17)}} onMouseEnter={() => {handleItemHover(17); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 18 ? 'active' : ''}`} onClick={() => {handleItemClick(18)}} onMouseEnter={() => {handleItemHover(18); positionInfoBulle();}} onMouseLeave={handleItemLeave}>
